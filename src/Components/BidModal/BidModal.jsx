...
const handleModalBid = async()=>{
  ...
  return (
      ...
      >
       ...
       <Input placeholder="Bid Price" value={bidPrice}  type="number" onChange={(e)=> setPrice(e.target.value)}/>
       <div className="modal-content">
       <Button
       onClick={handleModalBid}
       loading={loading}
       
       disabled={bidPrice <= price} className="bid-now">Bid Now</Button>
        

       {/* <button disabled={bidPrice < price} className="bid-now">Bid Now</button> */}
       </div>
